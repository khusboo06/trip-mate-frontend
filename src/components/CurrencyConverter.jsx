  ...
  return (
    <div
      className="
        ...
        p-5 sm:p-8
        text-center text-[#f9f7e8]
        relative overflow-hidden
      "
    >
      <div className="absolute inset-0 bg-gradient-to-r from-[#d4af37]/10 via-transparent to-[#b8860b]/10 blur-2xl -z-10" />

      <h2 className="text-2xl sm:text-3xl font-bold text-[#d4af37] mb-5 sm:mb-6 font-['Playfair_Display']">
        🌍 Currency Converter
      </h2>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5 mb-6">
        ...
        <div className="text-left">
          <label className="block text-xs sm:text-sm mb-1 text-[#f9f7e8]/70 font-medium">
            From Currency
          </label>
          <select
            value={fromCountry}
      ...
      {/* Buttons */}
      <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-5 mb-6">
        <button
      ...
      {/* Result Display */}
      {convertedAmount && (
        <div className="bg-[#0f172a]/60 border border-[#d4af37]/40 rounded-2xl py-4 px-4 sm:px-6 shadow-inner">
          <p className="text-sm sm:text-lg font-medium text-[#f9f7e8]/70 mb-1">
            Conversion Result:
          </p>
          <p className="text-xl sm:text-2xl font-extrabold text-[#d4af37] break-words">
