...
//   return (
//     <div className="flex items-center justify-center min-h-screen bg-gradient-to-b from-[#0f172a] via-[#1e293b] to-[#faf8f6] px-3">
//       <div className="w-full max-w-md bg-gradient-to-b from-[#1e293b]/90 to-[#0f172a]/90 backdrop-blur-xl border border-[#d4af37]/30 rounded-2xl shadow-2xl p-4 sm:p-8">
//         {/* Title */}
